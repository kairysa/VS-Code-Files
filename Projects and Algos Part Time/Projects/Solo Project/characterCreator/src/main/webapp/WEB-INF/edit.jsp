	...
	<main role="main" class="container d-flex justify-content-center">
		<div class="card m-3 shadow-lg">
			<div class="card-body m-3">
				<h1>Edit <c:out value="${selectedCharacter.name}"/></h1>
				<form:form action="/character/edit/${selectedCharacter.id}" modelAttribute="selectedCharacter" method="post" class="form-group">
					<form:label path="name">Character Name:</form:label>
					<form:errors path="name" class="text-danger"/>
					<form:input type="text" path="name" class="form-control" value="${selectedCharacter.name}"/>
					...
					<form:input type="text" path="hairColor" class="form-control" value="${selectedCharacter.hairColor}"/>
					
					<form:label path="eyeColor" class="mt-3">Eye Color:</form:label>
					<form:errors path="eyeColor" class="text-danger"/>
					<form:input type="text" path="eyeColor" class="form-control" value="${selectedCharacter.eyeColor}"/>
					
					<form:label path="age" class="mt-3">Age:</form:label>
					<form:errors path="age" class="text-danger"/>
					<form:input type="number" path="age" class="form-control" value="${selectedCharacter.age}"/>
					...
					<input type="submit" class="btn btn-primary mt-3 w-100" value="Submit Changes"/>
				</form:form>
			</div>
		</div>
	</main>
